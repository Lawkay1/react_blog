        ...
        <div className="max-w-2xl mx-auto">
            <nav className="border-gray-200">
                <div className="container mx-auto flex flex-wrap items-center justify-between">
                    ...
                    <div className={`hidden md:block w-full md:w-auto ${isMobileMenuOpen ? "block" : "hidden"}`} id="mobile-menu">
                        <ul className="flex-col md:flex-row flex md:space-x-8 mt-4 md:mt-0 md:text-sm md:font-medium">
                            ...
                            <li>
                                ...
                                {/* Dropdown menu */}
                                <div className={`absolute bg-white text-base z-10 list-none divide-y divide-gray-100 rounded shadow my-4 w-44 ${isDropdownOpen ? "block" : "hidden"}`}>
